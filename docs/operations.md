...
`tracepipe` is centered on observability work in Go. The technical target is: Reduce structured logs into trace spans and service latency summaries.
...
The score is deterministic. The current threshold is 150. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 2.
