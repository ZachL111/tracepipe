"""Regression checks for the tracepipe casebook."""
...
from casebook.harness import assert_expected, tracepipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tracepipe_summary(), assert_expected())
